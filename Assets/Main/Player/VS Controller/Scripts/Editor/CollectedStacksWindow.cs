...
namespace VSController
{
    ...
    {
        [SerializeField] private int grabbingInstanceID;
        ...
        public static void Open(Grabbing target)
        {
            ...
            if (target != null)
            {
                ...
                window.grabbingInstanceID = target.GetInstanceID();
        ...
        private void RestoreTarget()
        {
            ...
            if (grabbingInstanceID == 0)
                return;

            grabbing = EditorUtility.InstanceIDToObject(grabbingInstanceID) as Grabbing;
        ...
        private void OnSelectionChange()
        {
            ...
            grabbingInstanceID = grabbing.GetInstanceID();
            serializedGrabbing = new SerializedObject(grabbing);
